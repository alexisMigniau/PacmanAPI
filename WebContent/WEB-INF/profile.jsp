    	...
    	<div class="container">
	    	<c:if test="${empty profile }">
	    		...
	    		<div class="alert alert-danger" role="alert">
					Aucun joueur trouvé avec l'identifiant <b>${ param.idPlayer}</b>
				</div>
			</c:if>
				...
				<form method="post">
	        		...
	        		<div class="row">
	        			<div class="form-group col-md-6">
			                ...
			                <input ${editable ? "" : "disabled"} class="form-control ${not empty form.erreurs.login ? 'is-invalid' : '' }" type="text" id="login" name="login" value="${profile.login}" size="20" maxlength="20"  />
		                ...
		                <div class="form-group col-md-6">
	                		...
	                		<input ${editable ? "" : "disabled"} class="form-control ${not empty form.erreurs.pseudo ? 'is-invalid' : '' }" type="text" id="pseudo" name="pseudo" value="${profile.pseudo}" size="20" maxlength="20" />
	                ...
	                <c:if test="${editable }">
		                <div class="row">
		               		<button type="submit" class="btn btn-warning btn-block">Sauvegarder les informations du profil</button>
		                </div>
	                </c:if>
	                <br />
